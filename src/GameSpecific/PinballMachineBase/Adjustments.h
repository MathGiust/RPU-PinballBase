...
const AdjItem specificAdjustmentTable[NUMBER_OF_GS_ADJ] = {
        ...
        {EEPROM_ADJ_CAPTIVE_BALL_TIMER_BYTE, TYPE_BYTE, ADJ_RANGE,   0,  20,  1, nullptr, 15, &GS_EEPROM::captiveBallTimer },
        {EEPROM_ADJ_BUMPER_COUNT_BYTE,       TYPE_BYTE, ADJ_STEPPED, 10, 100, 5, nullptr, 30, &GS_EEPROM::bumperCount      },
        {EEPROM_ADJ_SPINNER_COUNT_BYTE,      TYPE_BYTE, ADJ_STEPPED, 10, 100, 5, nullptr, 30, &GS_EEPROM::spinnerCount     },
};

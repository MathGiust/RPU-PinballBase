...
// #define RPU_OS_USE_BALLY_PLAYFIELD_DISPLAY
...
#define RPU_OS_BIP_ENABLE_MASK 0x04
#else
#define RPU_OS_BIP_ENABLE_MASK 0x20
#define RPU_OS_MASK_SHIFT_1 0x30
#define RPU_OS_MASK_SHIFT_2 0x06
#endif

#ifdef RPU_OS_USE_BALLY_PLAYFIELD_DISPLAY
#define RPU_OS_NUMBER_OF_DISPLAYS 5
#else
#define RPU_OS_NUMBER_OF_DISPLAYS 4
#endif

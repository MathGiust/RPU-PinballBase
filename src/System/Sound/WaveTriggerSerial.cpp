...
__attribute__((deprecated("trackCounterReset() is deprecated. Please use isTrackCounterReset() instead."))) bool gpstarAudio::trackCounterReset() {
...
__attribute__((deprecated("resetTrackCounter(bool) is deprecated and will always reset to true. Please use resetTrackCounter() without passing a parameter instead."))) void gpstarAudio::resetTrackCounter(bool bReset) {
